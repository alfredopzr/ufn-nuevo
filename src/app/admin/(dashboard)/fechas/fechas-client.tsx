...
import { createFecha, updateFecha, deleteFecha } from "./actions";

interface Props {
  fechas: FechaImportante[];
}

export default function FechasClient({ fechas: initialFechas }: Props) {
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    const result = await createFecha({
  ...
  async function saveEdit(id: string) {
    const result = await updateFecha(id, {
